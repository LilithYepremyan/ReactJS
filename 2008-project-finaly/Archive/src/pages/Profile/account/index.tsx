      ...
      handleFollow(user.id).then((response) => {
        if (response.status == "following") {
          setUser({
            ...
            followers: [...user.followers, account],
          });
  ...
  return (
    user && (
      <div className="container mt-5 mb-5">
            ...
            <div className="d-flex flex-column">
              ...
              <div className="d-flex flex-row text-white ">
                <div
                  ...
                  className="p-4  text-center skill-block"
                >
                ...
                <div
                  style={{ borderLeft: " 1px solid #fff" }}
                  className="p-3  text-center skill-block"
                >
        ...
        {user.isPrivate == 0 && (
          <Gallery posts={user.posts ? user.posts : []} onUpdate={updatePost} />
        )}
      </div>
    )
  );
